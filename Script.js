    ...
    document.getElementById("rojo").addEventListener("click",cambiarFormayColor);
    document.getElementById("amarillo").addEventListener("click",cambiarFormayColor);
    document.getElementById("verde").addEventListener("click",cambiarFormayColor);
    document.getElementById("cruz").addEventListener("click",cambiarFormayColor);
    document.getElementById("cuadrado").addEventListener("click",cambiarFormayColor);
    document.getElementById("triángulo").addEventListener("click",cambiarFormayColor);

    function cambiarFormayColor() {
    if (document.getElementById("rojo").checked &&
    document.getElementById("cruz").checked) {
    ...
    if (document.getElementById("rojo").checked &&
    document.getElementById("cuadrado").checked) {
    ...
    if (document.getElementById("rojo").checked &&
    document.getElementById("triángulo").checked) {
